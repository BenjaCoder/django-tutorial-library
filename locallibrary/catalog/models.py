...
class Language(models.Model):
    ...
    class Meta:
        constraints = [UniqueConstraint(Lower('name'), name='language_name_case_insenstive_unique', violation_error_message="Language already exists (case insensitve match)")]
        ordering = ['name']